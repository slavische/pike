...
По умолчанию архив будет содержать `.so` файл скомпилированного плагина, manifest.yaml, папку с миграциями, а также папку _assets_.
...
В данном примере в папку assets будет скопирован файл `topology.toml`, _лежащий в корне плагина_.
